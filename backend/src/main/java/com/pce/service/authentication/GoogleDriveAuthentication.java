...
public class GoogleDriveAuthentication {
  ...
  //     }
  //   }
  private static final String CLIENTSECRET_LOCATION = "/pce.json";
  private static final String APPLICATION_NAME = "gky-syd-pce";
  ...
  static GoogleAuthorizationCodeFlow getFlow() throws IOException {
    if (flow == null) {
      InputStream in =
              GoogleDriveAuthentication.class.getResourceAsStream(CLIENTSECRET_LOCATION);
